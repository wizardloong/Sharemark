...
def upgrade() -> None:
    futures = [
        ...
        {
            "name": "Selfhosted Version",
            "slug": "selfhosted-version",
            "description": "Host Sharemark on your own servers for maximum control and customization.",
            "path": "images/future/selfhosted.png",
            "deadline_year": 2026,
            "deadline_quarter": 3,
        },
    ]
